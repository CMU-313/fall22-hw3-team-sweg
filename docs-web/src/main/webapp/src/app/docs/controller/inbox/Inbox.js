...
angular.module('docs').controller('Inbox', function($scope, Restangular) {
    // geeksforgeeks for loop example https://www.geeksforgeeks.org/angularjs-angular-foreach-function/
    $scope.names = [];
    // the list of messages from backend should be sorted in most recent message
    var values = [
